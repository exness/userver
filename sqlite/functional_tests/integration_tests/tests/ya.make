...
INCLUDE(
    ${ARCADIA_ROOT}/taxi/integration_testing/integration_test.ext
)

ALL_PYTEST_SRCS()

DEPENDS(
    taxi/uservices/userver/sqlite/functional_tests/integration_tests
)

DATA(
    arcadia/taxi/uservices/userver/sqlite/functional_tests/integration_tests
)
